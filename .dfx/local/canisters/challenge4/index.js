...
import { idlFactory } from './challenge4.did.js';
export { idlFactory } from './challenge4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CHALLENGE4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./challenge4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the challenge4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./challenge4.did.js")._SERVICE>}
 */
export const challenge4 = createActor(canisterId);
